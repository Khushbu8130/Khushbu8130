...
💻 Full Stack Developer | 🧠 Strong in DSA | 🤖 AI/ML Learner

I am a Computer Science Engineering student from KKCEM, Dhanbad, with hands-on experience in building real-world full-stack applications and a strong foundation in data structures, algorithms, and problem-solving.
...
🎨 Create responsive and clean UIs using Tailwind CSS

🔗 Develop RESTful APIs and integrate third-party services

🧠 Strengthen core CS fundamentals through consistent DSA practice
...
Contributed to production-level features, backend APIs, and frontend components while collaborating with the development team.
